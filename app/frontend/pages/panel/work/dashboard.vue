...
const quickActions = [
  { label: 'Invite a member', to: '/members', icon: 'i-solar-user-plus-line-duotone' },
  { label: 'Schedule an activity', to: '/activities', icon: 'i-solar-calendar-add-line-duotone' },
  { label: 'Review join requests', to: '/join-requests', icon: 'i-solar-inbox-line-duotone' },
];
</script>
      ...
      >
        <template #actions>
          <UButton
            ...
            variant="outline"
            size="sm"
            trailing-icon="i-solar-arrow-right-line-duotone"
          >
            View all
          </UButton>
        </template>
        <DashboardEmptyState
          icon="i-solar-inbox-line-duotone"
        ...
        <ul class="-my-2 divide-y divide-default">
          ...
          >
            ...
            >
              ...
              {{ action.label }}
              <UIcon
                name="i-solar-arrow-right-line-duotone"
